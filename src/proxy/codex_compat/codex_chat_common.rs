//! Vendored from cc-switch (MIT, https://github.com/farion1231/cc-switch).
//! Source: src-tauri/src/proxy/providers/codex_chat_common.rs
//! Local adaptations: replaced `crate::proxy::*` paths with `super::*` for our codex_compat layout.
//!
//! Some helpers in this file are only used by cc-switch's non-streaming
//! `transform_codex_chat` (which we don't vendor). We keep them here verbatim
//! to preserve a 1:1 vendor footprint, but silence the resulting dead_code
//! warnings.
